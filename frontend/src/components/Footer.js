...
function footer() {
  ...
  return (
    <div>
      <footer style={{  backgroundColor: "#E2DCD0" ,color:"#000"}} class="text-center text-lg-start bg-body-tertiary text-muted">
       
        <div style={{color:"#000"}} class="me-5 d-none d-lg-block">
            <span>Get connected with us on social networks:</span>
          </div>
        <section style={{color:"#000"}} class="">
